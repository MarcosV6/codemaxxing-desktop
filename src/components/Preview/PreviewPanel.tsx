...
export function PreviewPanel() {
  ...
  // When a browser_* tool fires, the store requests the Browser tab — switch to
  // it so the webview mounts + can receive the agent's command, then clear it.
  useEffect(() => { if (previewTab) { setTab(previewTab); setPreviewTab(null) } }, [previewTab, setPreviewTab])
...
// The same webview is what the agent drives via the browser_* tools.
function BrowserTab() {
