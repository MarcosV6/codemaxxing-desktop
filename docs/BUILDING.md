...
cd codemaxxing-desktop
gh release upload v1.3.11 release/<file-1> release/<file-2> --repo MarcosV6/codemaxxing-desktop
```
...
- **`release.yml`** — runs when you push a tag like `v1.3.11`. It packages in
